                                ...
                                <div class="d-lg-flex menu_banners">
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/menu_banner1.jpg" alt="menu_banner1">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/menu_banner2.jpg" alt="menu_banner2">
                                            <div class="banne_info">
                                                <h6>15% Off</h6>
                                                <h4>Men's Fashion</h4>
                                                <a href="#">Shop now</a>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/menu_banner3.jpg" alt="menu_banner3">
                                            <div class="banne_info">
                                                <h6>23% Off</h6>
                                                <h4>Kids Fashion</h4>
                                                <a href="#">Shop now</a>
                                            ...
                                            <div class="header_banner_content">
                                                <div class="shop_banner">
                                                    <div class="banner_img overlay_bg_40">
                                                        <img src="<?php  echo get_theme_file_uri();?>/assets/images/shop_banner.jpg" alt="shop_banner"/>
                                                    </div> 
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="single_banner">
                    <img src="<?php  echo get_theme_file_uri();?>/assets/images/shop_banner_img1.jpg" alt="shop_banner_img1"/>
            ...
            <div class="col-md-6">
                <div class="single_banner">
                    <img src="<?php  echo get_theme_file_uri();?>/assets/images/shop_banner_img2.jpg" alt="shop_banner_img2"/>
                    <div class="single_banner_info">
                        ...
                        <div class="row shop_container">
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img1.jpg" alt="product_img1">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img2.jpg" alt="product_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img3.jpg" alt="product_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img4.jpg" alt="product_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img5.jpg" alt="product_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img6.jpg" alt="product_img6">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img7.jpg" alt="product_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img8.jpg" alt="product_img8">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="row shop_container">
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img9.jpg" alt="product_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img11.jpg" alt="product_img11">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img12.jpg" alt="product_img12">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="<?php  echo get_theme_file_uri();?>/assets/images/product_img10.jpg" alt="product_img10">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
            ...
            <div class="col-lg-9">
                <div class="testimonial_wrap testimonial_style1 carousel_slider owl-carousel owl-theme nav_style2" data-nav="true" data-dots="false" data-center="true" data-loop="true" data-autoplay="true" data-items='1'>
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="<?php  echo get_theme_file_uri();?>/assets/images/user_img1.jpg" alt="user_img1" />
                            </div>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="<?php  echo get_theme_file_uri();?>/assets/images/user_img2.jpg" alt="user_img2" />
                            </div>
                            <div class="author_name">
                                <h6>Alden Smith</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="<?php  echo get_theme_file_uri();?>/assets/images/user_img3.jpg" alt="user_img3" />
                            </div>
                            <div class="author_name">
                                <h6>Daisy Lana</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="<?php  echo get_theme_file_uri();?>/assets/images/user_img4.jpg" alt="user_img4" />
                            </div>
                            <div class="author_name">
                                <h6>John Becker</h6>
                                <span>Designer</span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/logo_light.png" alt="logo"/></a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="footer_payment text-center text-lg-right">
                        <li><a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/visa.png" alt="visa"></a></li>
                        <li><a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/discover.png" alt="discover"></a></li>
                        <li><a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/master_card.png" alt="master_card"></a></li>
                        <li><a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/paypal.png" alt="paypal"></a></li>
                        <li><a href="#"><img src="<?php  echo get_theme_file_uri();?>/assets/images/amarican_express.png" alt="amarican_express"></a></li>
                    </ul>
                </div>
            </div>
        </div>
